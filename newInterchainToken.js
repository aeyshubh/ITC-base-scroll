...
const interchainTokenServiceContractABI = require("./utils/interchainTokenABI.json");
...
async function registerAndDeploy() {
    ...
    const tokenAddress = await interchainTokenServiceContract.getInterchainTokenAddress(tokenId);
